                ...
                <div class="max-w-lg mx-auto">
                    <form action="{{route('compra.update', $compra)}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input value=" {{old('fecha', $compra->fecha)}} " type="date" id="fecha" name="fecha" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
                        </div>
                        <div class="mb-6">
                            <label for="descripcion" class="text-sm font-medium text-gray-900 block mb-2">Descripcion: </label>
                            <input value=" {{old('descripcion', $compra->descripcion)}} " type="text" id="descripcion" name="descripcion" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
                        </div>
                        <div class="mb-6">
                            <label for="unidad" class="text-sm font-medium text-gray-900 block mb-2">Unidad: </label>
                            <input value=" {{old('unidad', $compra->unidad)}} " type="text" id="unidad" name="unidad" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
                        </div>
                        <div class="mb-6">
                            <label for="cantidad" class="text-sm font-medium text-gray-900 block mb-2">Cantidad: </label>
                            <input value=" {{old('cantidad', $compra->cantidad)}} " type="text" id="cantidad" name="cantidad" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
                        </div>
                        <div class="mb-6">
                            <label for="precio" class="text-sm font-medium text-gray-900 block mb-2">Precio: </label>
                            <input value=" {{old('precio', $compra->precio)}} " type="text" id="precio" name="precio" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
                        </div>
                        <div class="mb-6">
                            <label for="subtotal" class="text-sm font-medium text-gray-900 block mb-2">Subtotal: </label>
                            <input value=" {{old('subtotal', $compra->subtotal)}} " type="text" id="subtotal" name="subtotal" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
                        </div>
                        <div class="mb-6">
                            <label for="total" class="text-sm font-medium text-gray-900 block mb-2">Total: </label>
                            <input value=" {{old('total', $compra->total)}} " type="text" id="total" name="total" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
                        </div>
