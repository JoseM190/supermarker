                    ...
                    <form action="{{route('compra.store')}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="unidad" name="unidad"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="Ingrese la unidad" value=" {{old('unidad')}} ">
                        </div>
                        @error('unidad')
                            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                                role="alert">
                        ...
                        @enderror
                        <div class="mb-6">
                            <label for="subtotal" class="text-sm font-medium text-gray-900 block mb-2">Sub Total: </label>
                            <input type="text" id="subtotal" name="subtotal"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="Ingrese el subtotal" value=" {{old('subtotal')}} ">
                        </div>
                        @error('subtotal')
                            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                                role="alert">
